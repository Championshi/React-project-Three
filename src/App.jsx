...
function App() {
  ...
  return (
    <>
   <h1  className='bg-pink-600 p-10 text-black rounded-xl'>Welcome  To tailwind </h1>
   <section>
      ...
      <div class="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
        ...
        <p class="mt-2 text-sm text-white-600">
          ...
          <a
            href="#"
            title=""
            class="font-semibold text-green transition-all duration-200 hover:underline"
          >
        ...
        <form action="#" method="POST" class="mt-8">
          <div class="space-y-5">
            <div>
              <label for="" class="text-base font-medium text-white-900">
                {" "}
                Email address{" "}
              </label>
              <div class="mt-2">
